...
function CybornFooter(){
  return(
    <footer className="bg-black text-center lg:text-left text-white">
    <hr />
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
      <div className="">
        ...
        <p>
          Asia&#39;s first and largest NFT Market.
        </p>
  ...
  <div className="text-center p-6 bg-black">
    ...
    <a className="text-white text-left" href="https://cybornnft.com">Cyborn</a>
  </div>
</footer>
  )
}
