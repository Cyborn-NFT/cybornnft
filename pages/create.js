...
function Create() {
    ...
    return ( <
        ...
        <
        p className = "font-extralight" > File types supported: JPG, PNG, GIF, SVG, MP4, WEBM, MP3, WAV.Max Size: 100 MB < /p> <
        br / >
        <
        br / >
        <
        ...
        label
        for = "dropzone"
        class = "flex flex-col justify-center items-center w-full h-64 bg-transparent rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-white/25 dark:bg-transparent hover:bg-white dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600" >
        <
        div class = "flex flex-col justify-center items-center pt-5 pb-6" >
        <
        svg class = "mb-3 w-10 h-10 text-gray-400"
        fill = "none"
        stroke = "currentColor"
        viewBox = "0 0 24 24"
        ...
        <
        p class = "text-xs text-gray-500 dark:text-gray-400" > SVG, PNG, JPG or GIF(MAX.800 x400px) < /p> <
        /div> <
        input id = "dropzone"
        onChange = { onChange }
        type = "file"
        ...
        <
        p > Properties < /p> <
        input placeholder = 'Asset Properties'
        className = 'form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-transparent border border-solid border-gray-300 rounded-full transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none'
        onChange = {
            (e) =>
        ...
        <
        p > Supply < /p> <
        input placeholder = 'Token Supply'
        className = 'form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-transparent border border-solid border-gray-300 rounded-full transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none'
        min = '0'
        max = '3' /
        >
        ...
        for = "flexSwitchCheckChecked" > Toggle
        for selection < /label> <
        /div> <
        /div> <
        /div> <
        ...
        div className = 'flex-1 shrink-0 h-full w-full object-cover md:h-full' > {
            fileUrl && ( <
                ...
                src = { fileUrl }
                /> <
                video autoPlay loop className = 'rounded mt-4'
                width = '500'
                height = '500' >
                <
                source src = { fileUrl }
