...
import PolygonIndex from '/components/PolygonIndex';
        ...
        <div className='flex items-center flex-col justify-center lg:flex-row py-28 px-6 md:px-24 md:py-20 lg:py-32 gap-16 lg:gap-28'>
          ...
          <div className='w-full lg:w-1/2'>
            ...
            <button
              ...
              onClick={() => router.push('/polygon/signin')}
            >
              Go back to Homepage
            </button>
          </div>
  ...
  return (
    <div>
        ...
        <div className='relative max-w-screen-xl px-8 py-32 mx-auto lg:h-screen lg:items-center lg:flex'>
          <div className='max-w-xl text-center sm:text-left'>
            ...
            <div className='flex flex-wrap gap-4 mt-8 text-center'>
              ...
              <button
                onClick={() => signIn()}
                className='block w-full px-12 py-3 text-sm font-medium text-white rounded shadow bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50'
              >
                SignIn
              </button>
            </div>
      ...
      <div>
        ...
        <div
          id='items'
          className='relative max-w-screen-xl px-4 py-24 mx-auto lg:items-center lg:flex lg:grid grid-cols-4 gap-4'
        >
          {results.map((item, index) => {
            return (
              <div
                key={index}
                className='block p-8 max-w-sm rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-cybornheader dark:border-gray-700 dark:hover:bg-gray-700'
              >
                <div className='max-w-sm rounded overflow-hidden shadow-lg'>
                  ...
                  <div className='px-6 pt-4 pb-2'>
                    <button
                      onClick={() =>
                        router.push(
                          `https://cybornnft.vercel.app/polygon/${item.seller}`
                        )
                      }
                      className='w-full lg:w-auto my-4 rounded-full px-1 sm:px-16 py-2 bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50'
                    >
                      Visit
                    </button>
                  </div>
