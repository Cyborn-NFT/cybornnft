  ...
  if (loadingState === 'loaded' && !nfts.length)
    return (
      <div>
        <PolygonHeader />
        <hr />
        <h1 className='px-20 py-10 text-6xl text-white'>
            ...
            {nfts.map((nft, i) => (
              <div key={i} className='rounded-xl overflow-hidden'>
                ...
                <div className='p-4 bg-cybornheader'>
                  ...
                  >
                    Link:{' '}
                    {`https://cybornnft.vercel.app/polygon/${nft.seller}/${nft.tokenId}`}
                  </p>
                  <p className='text-xl mb-4 font-bold text-white'>
                    {nft.price} Matic
                  </p>
                  <button
                    className='w-full bg-blue-400 text-black font-bold py-2 px-12 rounded'
                    onClick={() => buyNft(nft)}
                  >
                    Buy
                  </button>
