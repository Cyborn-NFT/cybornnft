    ...
    return ( <
        ...
        div className = 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4' > {
            nfts.map((nft, i) => ( <
                ...
                div className = '' >
                <
                TelegramShareButton url = { `https://cybornnft.vercel.app/${nft.seller}/${nft.tokenId}` }
                ...
                div className = '' >
                <
                TwitterShareButton url = { `https://cybornnft.vercel.app/${nft.seller}/${nft.tokenId}` }
                title = { "Here's my NFT Link" } >
                <
        ...
        div > {
            showModal ? ( <
                ...
                <
                input placeholder = 'Auction Asset Name'
                ...
                br / >
                <
                textarea placeholder = 'Start Auction Price'
                ...
                br / >
                <
                input placeholder = 'End Auction Price'
                className = 'mt-2 border rounded p-4 block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer' /
                >
                <
                br / >
