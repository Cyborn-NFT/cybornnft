  ...
  return (
    ...
    <div className="section home-explore flex items-center">
      <div className="home-explore-content container-default mx-auto">
        ...
        <div id="items" className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
          {
            nfts.map((nft, i) => (
    ...
    <div className="section home-explore flex items-center">
      <div className="home-explore-content container-default mx-auto">
        ...
        <div id="collections" className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-4 pt-4">
