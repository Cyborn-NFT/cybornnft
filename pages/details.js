        ...
        <div className="lg:p-32">
          ...
          <div className="lg:grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p>
                Owned By &nbsp;
                <span className="font-extralight">wallet/author</span>
              </p>
              <br />
            ...
            <p>
              Created By &nbsp;
              <span className="font-extralight">Owner Address</span>
            </p>
            <br />
            <p>
              About &nbsp;
              <span className="font-extralight">Collection Name</span>
            </p>
            <br />
            <p className="font-extralight">
              Some Paragraph go here about the collection and author tags
            </p>
          </div>
          <br />
...
export default withRouter(connect(mapStateToProps, mapDipatchToProps)(Details));
