        ...
        <div className='lg:grid grid-cols-4'>
          <div>
            <img
              ...
              src={`https://cgpgvbeatwfizpzzaned.supabase.co/storage/v1/object/public/avatars/${avatar_url}`}
            />
            <h1 className='lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-white items-center justify-center hover:bg-background hover:text-white '>
              {username}
            </h1>
            <Link href={`${website}`}>
